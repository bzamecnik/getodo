...
#ifndef GETODOGUI_TASK_MODEL_H
#define GETODOGUI_TASK_MODEL_H
...
public:
	 ...
	 * \return RefPtr to the TaskTreeStore instance
	 */
	 ...
	 * Search for the task by its id in the tree and return an iterator
	 * to row where it is.
	 * \param task task to find
	 * \return iterator to the task or children().end() if nothing found
	 */
...
protected:
	...
	/** Refresh the model.
	 * Clean the model and insert all the tasks from the TaskManager in a batch.
	 *
