...
# including this file OR remove mkdep.c from your directory.
ifeq (,$(wildcard mkdep.c))
...
#ShakeNMake.CISH_SOURCES += $(wildcard code/*.?pp)
ifneq (,$(ShakeNMake.CISH_SOURCES))
ShakeNMake.CISH_DEPS_FILE = .make.c_deps

ShakeNMake.BINS.MKDEP = ./mkdep
PACKAGE.DIST_FILES += mkdep.c
$(ShakeNMake.BINS.MKDEP): mkdep.c
	$(CC) -o $@ $^
...
$(ShakeNMake.CISH_DEPS_FILE): $(PACKAGE.MAKEFILE) $(ShakeNMake.MAKEFILE) $(ShakeNMake.BINS.MKDEP) $(ShakeNMake.CISH_SOURCES)
	@$(ShakeNMake.BINS.MKDEP) $(INCLUDES) -- $(ShakeNMake.CISH_SOURCES) 2>/dev/null > $@ || \
